...
const MCPManifestForm = ({ form, isEditMode }: MCPManifestFormProps) => {
  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      // Use the testMcpConnection method from mcpStore
      ...
      if (result.success && result.manifest) {
        ...
        // The store has already handled the error state; here we can optionally show additional user-friendly messages
                ...
                rules={[
                  { message: t('dev.mcp.url.required'), required: true },
                  {
                    ...
                    validator: async (_, value) => {
                      ...
                      // Automatically throws an error if the value is not a valid URL
                      new URL(value);
                    },
                  },
                ]}
