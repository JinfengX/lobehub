...
class TaskService {
  ...
  update = async (
    ...
    data: {
      ...
      description?: string;
      // heartbeatInterval: periodic execution interval (seconds), controls how often the task runs automatically
  ...
  // safely merges config (does not overwrite other config fields such as checkpoint/review)
