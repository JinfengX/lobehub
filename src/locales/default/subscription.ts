export default {
  ...
  'plans.embeddingStorage.tooltip':
    'One document page — roughly 1000–1500 characters — generates approximately 1 vector entry. Estimated using OpenAI Embeddings; may vary by model.',
  ...
  'plans.free': 'Free',
  'plans.freeTrial': 'Register to get free trial of {{name}}, no credit card required',
  ...
  'plans.knowledgeBase.tooltip':
    'Upload documents, images, audio, and video. Organize them into a knowledge base and use them in conversations for better responses.',
  ...
  'qa.list.credit.a':
    'Credits measure your AI usage in {{cloud}}. Different models cost different amounts. Some agent skills and third-party services also use credits.',
  ...
  'qa.list.free.a':
    '{{name}} has always adhered to open source principles. For professional developers, you can use all open source capabilities through self-deployment of the community version. In {{cloud}}, we provide all registered users with {{credit}} free computing credits per month, ready to use immediately — no setup required. If you need more usage, you can subscribe to {{starter}}, {{premium}} or {{ultimate}}.',
