...
If your deployment accumulated historical residual data before the knowledge-base deletion fix was introduced, refer to the dedicated cleanup runbook:

<Cards>
  <Card href={'/docs/self-hosting/advanced/knowledge-base-orphan-cleanup'} title={'Clean Historical Orphaned Knowledge Base Data'} />
</Cards>
